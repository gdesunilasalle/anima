   ...
   <div class="footer-copyright py-3 text-left sombras text-white" style="background-color:#660298;">
    ...
    <!-- confirmações Modals -->
    <!-- alertaModal4 = ESQUECI SENHA -->
    <div class="comofunciona-modal modal fade" id="alertaModal4" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body" align="center">
                  ...
                  <p><a href="#" class="btn btn-success">Recuperar senha!</a></p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Voltar</button>
                </div>
