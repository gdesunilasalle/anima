      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <p class="text-muted">Atentos às necessidades de locomoção dos estudantes da Unilasalle-RJ, os alunos de Sistema de Informação tiveram a ideia de promover um ambiente para compartilhamento de meio de transporte de um modo confiável e agradável.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
